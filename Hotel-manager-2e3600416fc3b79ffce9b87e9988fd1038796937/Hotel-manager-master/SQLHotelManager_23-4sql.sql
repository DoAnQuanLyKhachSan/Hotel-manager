...
CREATE TABLE HINHTHUCTHUE(
	MaHinhThucThue INT NOT NULL PRIMARY KEY,
...
INSERT INTO dbo.HINHTHUCTHUE( MaHinhThucThue, TenHinhThucThue, SoGio, TyLeDonGia )VALUES  ( 1, N'Thuê Theo Ngày', 24, 1.0)
INSERT INTO dbo.HINHTHUCTHUE( MaHinhThucThue, TenHinhThucThue, SoGio, TyLeDonGia )VALUES  ( 2, N'Thuê Theo Giờ', 1, 0.2)
GO
...
INSERT INTO dbo.NHAN_VIEN( HoTen,NgaySinh,NgayKyHopDong,SoHopDong,MaBacLuong,MaPhongBan,MaChucVu )VALUES  (N'DuyAnhStaff','22/09/1998','20/04/2018',1,1,1,1)
GO
